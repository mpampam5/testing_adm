      ...
      <div class="card-body">
        <div class="col-12 mb-1">
          ...
          <div class="pull-right">
            <a href="<?=site_url("backend/personal/export/3")?>" class="btn btn-success btn-sm text-white" target="_blank"><i class="fa fa-file-excel-o"></i> Export</a>
          </div>
          <?php endif; ?>
        </div>
...
$(document).ready(function(){
  ...
  //datatables
    table = $('#table').DataTable({
        ...
        "ajax": {
            "url": "<?php echo site_url('backend/agency/json')?>",
            "type": "POST",
            "data": function ( data ) {
