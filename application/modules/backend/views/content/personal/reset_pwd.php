  ...
  <div class="col-12">
    <form action="<?=$action?>" id="form">
      <div class="form-group">
        <label for="">Masukkan Password Akun Anda</label>
        <input type="password" class="form-control" id="password_verif" name="password_verif" placeholder="Verifikasi Password" >
      </div>
