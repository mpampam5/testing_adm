...
class Co_founders extends MY_Controller{
  ...
  public function __construct()
  {
    ...
    $this->load->model("Co_founder_model","model");
  }

  function index()
  {
    $this->template->set_title("CO Founder");
    $this->template->view("content/co_founder/index");
  }
